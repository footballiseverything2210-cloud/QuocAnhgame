...
body{
    ...
    background:url("6e46f401-fa81-48d9-b946-f742e1be7b31.png") center center/cover no-repeat fixed;
...
if(snake.length<8) return "Chậm";

if(snake.length<15) return "Nhanh";
